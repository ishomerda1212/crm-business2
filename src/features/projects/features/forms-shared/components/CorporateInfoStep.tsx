      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-200 bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-shadow"
          >
